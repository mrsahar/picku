...
class ForgotPasswordController extends GetxController {
  ...
  Future<void> forgotPassword() async {
    ...
    try {
      ...
      print(' SAHArSAHAr 📤 ForgotPassword: Sending request for email: ${emailController.text}');
      final response = await _apiProvider.forgotPassword(forgotPasswordRequest);

      print(' SAHArSAHAr 📥 ForgotPassword: Response received - Success: ${response.success}');
      ...
      print(' SAHArSAHAr 💥 ForgotPassword: Exception caught: $e');
      print(' SAHArSAHAr 📍 ForgotPassword: Stack trace: $stackTrace');
      Get.snackbar(
        'Error',
